...
package org.woltage.irssiconnectbot.transport;
...
import org.woltage.irssiconnectbot.service.TerminalManager.KeyHolder;
...
//		pubkey.setType(PubkeyDatabase.KEY_TYPE_IMPORTED);
	...
	/* (non-Javadoc)
	 * @see org.woltage.irssiconnectbot.transport.AbsTransport#usesNetwork()
	 */
	@Override
